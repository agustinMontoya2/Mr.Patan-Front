...
export const Search: React.FC<ISearchBar> = ({searchTerm, setSearchTerm}) => {
  return (
    <div className="bg-whiteTransparent text-[rgb(0, 0, 0)] w-[70%] mlg:w-[40%] mx-3 flex items-center flex-row justify-around border-solid border-[rgb(0,0,0)] border-2 rounded-2xl text-lg font-kanit">
                                    <SearchIcon
