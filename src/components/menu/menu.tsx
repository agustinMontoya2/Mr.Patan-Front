...
export const MenuBurger: React.FC<IMenuItem> = ({menuOpen, toggleMenu}) => {
    ...
    return (
        <div className={`fixed top-0 right-0 z-40 bg-whiteTransparent text-[rgb(0,0,0)] w-[70%] h-screen flex flex-col items-center justify-center transition-transform duration-300 ${menuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
